...
export function calculateGST(amount, category) {
  ...
  if (
    ...
    {
      case "essential": gstRate = 0; break;
      case "food": gstRate = 5; break;
      case "standard": gstRate = 12; break;
      case "electronics": gstRate = 18; break;
      case "luxury": gstRate = 28; break;
      default: return null;
    }

  const gstAmt = (amount * gstRate)/100
  const totalAmount = gstAmt + amount;
  return {baseAmount: amount, gstRate: gstRate, gstAmount: parseFloat(gstAmt.toFixed(2)), totalAmount:parseFloat(totalAmount.toFixed(2))}
}
